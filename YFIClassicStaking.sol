...
contract YFIClassicStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // YFIC token contract address
    address public constant tokenAddress = 0x704135ECBb0BEA17FD3DAad8E3583ccC6f6f7f0E;
    ...
    // unstaking possible after 72 hours // 3 Days
